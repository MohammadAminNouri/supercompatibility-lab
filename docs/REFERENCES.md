...
## NiTi B2/B19′ orientation-cycle reference

**What EBSD and TKD Tell Us about the Crystallography of the Martensitic B2-B19′ Transformation in NiTi Shape Memory Alloys** (Crystals, 2020, 10, 562)  
DOI: <https://doi.org/10.3390/cryst10070562>  
Used for the metric-aware natural/AQ orientation-relation quick setup: `(010)B19′ ∥ (110)B2` and `[101]B19′ ∥ [−1 1 1]B2`.
